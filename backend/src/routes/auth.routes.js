...
import { registerAsync, loginAsync, logout, justinfo, checkExistingUserByMail, getUserEncryptedPassword } from "../controllers/auth.controller.js";
...
router.post("/encryptpassword", getUserEncryptedPassword)
